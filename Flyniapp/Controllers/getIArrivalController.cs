...
{
    /// <summary>
    /// Api que contiene el recurso de Llegadas Internacionales
    /// </summary>
    public class getIArrivalController : ApiController
    {

        private FLYNIDBEntities context = new FLYNIDBEntities();
        /// <summary>
        /// Este metodo obtiene la lista de los Vuelos de Llegadas Internacionales
        /// url: api/getIArrival
        /// </summary>
        ...
        {           
            ...
            var obj = context.sp_getAllFlight(4);
